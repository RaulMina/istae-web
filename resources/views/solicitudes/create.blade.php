...
@section('title', 'Nueva Solicitud de Prácticas')
        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    <h2 class="mb-0"><i class="bi bi-file-earmark-plus"></i> Nueva Solicitud de Prácticas</h2>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nombres_apellidos_estudiante" name="nombres_apellidos_estudiante" value="{{ old('nombres_apellidos_estudiante') }}">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="carrera" name="carrera" >
                                        ...
                                        <option value="Tecnología Superior en Desarrollo de Software" {{ old('carrera') == 'Tecnología Superior en Desarrollo de Software' ? 'selected' : '' }}>
                                            Tecnología Superior en Desarrollo de Software
                                        </option>
                                        <option value="Tecnología Superior en Mecanización Agrícola" {{ old('carrera') == 'Tecnología Superior en Mecanización Agrícola' ? 'selected' : '' }}>
                                            Tecnología Superior en Mecanización Agrícola
                                        </option>
                                        <option value="Tecnología Superior en Mecánica Automotriz" {{ old('carrera') == 'Tecnología Superior en Mecánica Automotriz' ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control" id="institu_destino" name="institu_destino" >
                                        ...
                                        @if(isset($componentesFormatos['institu_destino']))
                                            @foreach($componentesFormatos['institu_destino'] as $componente)
                                                <option value="{{ $componente->campos }}" {{ old('institu_destino') == $componente->campos ? 'selected' : '' }}>
                                    ...
                                    <select class="form-control" id="tutor_academico" name="tutor_academico" >
                                        ...
                                        @if(isset($componentesFormatos['tutor_academico']))
                                            @foreach($componentesFormatos['tutor_academico'] as $componente)
                                                <option value="{{ $componente->campos }}" {{ old('tutor_academico') == $componente->campos ? 'selected' : '' }}>
                                                    {{ ucwords(str_replace('_', ' ', $componente->campos)) }}
                                                </option>
                                            @endforeach
                                        @endif
                                    ...
                                    <select class="form-control" id="proyecto_asigando" name="proyecto_asigando" >
                                        ...
                                        @if(isset($componentesFormatos['proyecto_asigando']))
                                            @foreach($componentesFormatos['proyecto_asigando'] as $componente)
                                                <option value="{{ $componente->campos }}" {{ old('proyecto_asigando') == $componente->campos ? 'selected' : '' }}>
                                                    {{ ucwords(str_replace('_', ' ', $componente->campos)) }}
                                                </option>
                                            @endforeach
                                        @endif
                                    ...
                                    <select class="form-control" id="codificacion_proyecto" name="codificacion_proyecto" >
                                        ...
                                        @if(isset($componentesFormatos['codificacion_proyecto']))
                                            @foreach($componentesFormatos['codificacion_proyecto'] as $componente)
                                                <option value="{{ $componente->campos }}" {{ old('codificacion_proyecto') == $componente->campos ? 'selected' : '' }}>
                                                    {{ ucwords(str_replace('_', ' ', $componente->campos)) }}
                                                </option>
                                            @endforeach
                                        @endif
                                    ...
                                    <select class="form-control" id="codificacion_programa" name="codificacion_programa" >
                                        ...
                                        @if(isset($componentesFormatos['codificacion_programa']))
                                            @foreach($componentesFormatos['codificacion_programa'] as $componente)
                                                <option value="{{ $componente->campos }}" {{ old('codificacion_programa') == $componente->campos ? 'selected' : '' }}>
                                                    {{ ucwords(str_replace('_', ' ', $componente->campos)) }}
                                                </option>
                                            @endforeach
                                        @endif
                                    ...
                                    <select class="form-control" id="numeracion_proyecto" name="numeracion_proyecto" >
                                        ...
                                        @if(isset($componentesFormatos['numeracion_proyecto']))
                                            @foreach($componentesFormatos['numeracion_proyecto'] as $componente)
                                                <option value="{{ $componente->campos }}" {{ old('numeracion_proyecto') == $componente->campos ? 'selected' : '' }}>
                                                    {{ ucwords(str_replace('_', ' ', $componente->campos)) }}
                                                </option>
                                            @endforeach
                                        @endif
                                    ...
                                    <select class="form-control" id="periodo" name="periodo" >
                                        ...
                                        @if(isset($componentesFormatos['periodo']))
                                            @foreach($componentesFormatos['periodo'] as $componente)
                                                <option value="{{ $componente->campos }}" {{ old('periodo') == $componente->campos ? 'selected' : '' }}>
                                                    {{ ucwords(str_replace('_', ' ', $componente->campos)) }}
                                                </option>
                                            @endforeach
                                        @endif
                                    ...
                                    <select class="form-control" id="codigo_practicas" name="codigo_practicas">
                                        ...
                                        @if(isset($componentesFormatos['codigo_practicas']))
                                            @foreach($componentesFormatos['codigo_practicas'] as $componente)
                                                <option value="{{ $componente->campos }}" {{ old('codigo_practicas') == $componente->campos ? 'selected' : '' }}>
                                                    {{ ucwords(str_replace('_', ' ', $componente->campos)) }}
                                                </option>
                                            @endforeach
                                        @endif
                                    ...
                                    <select class="form-control" id="nombre_programa" name="nombre_programa">
                                        ...
                                        @if(isset($componentesFormatos['nombre_programa']))
                                            @foreach($componentesFormatos['nombre_programa'] as $componente)
                                                <option value="{{ $componente->campos }}" {{ old('nombre_programa') == $componente->campos ? 'selected' : '' }}>
                                                    {{ ucwords(str_replace('_', ' ', $componente->campos)) }}
                                                </option>
                                            @endforeach
                                        @endif
