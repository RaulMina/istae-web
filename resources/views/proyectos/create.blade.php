                    ...
                    @if(session('error'))
                        ...
                        <form method="POST" action="{{route('proyectos.store')}}"enctype="multipart/form-data" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="name_py" id="name_py" class="form-control" placeholder="" required autofocus>
                            </div>
                            <div class="form-group">
                                <label for="detalle_py">Descripción</label>
                                <input type="text" name="detalle_py" id="detalle_py" class="form-control" placeholder="" required autofocus>
                            </div>
